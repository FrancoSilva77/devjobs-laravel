                            ...
                            <div class="p-5 lg:flex lg:justify-between lg:items-center">
                                <div>
                                    <p>Tienes un candidato en:
                                        <span class="font-bold">{{ $historialNotificacion->data['nombre_vacante'] }} -
                                            {{ $historialNotificacion->created_at->diffForHumans() }}</span>
                                    </p>
                                </div>
                                <div class="mt-5 lg:mt-0">
                                    <a href="{{ route('candidatos.index', $historialNotificacion->data['id_vacante']) }}"
